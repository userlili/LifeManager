...
const { handleEdit, handleAdd } = useSimpleList<BillModel>(articleUrl) as SimpleListType;

const visible = ref(false);
const ruleFormRef = ref<FormInstance>();
const title = ref("");
const { gtMd } = useScreenPixel();
const model = ref<Partial<BillModel>>({});
const isEdit = computed<boolean>(() => {
  return model.value.uid !== undefined;
});
...
function edit(record: BillModel) {
  ...
  return [
    {
      ...
      rules: [
        {
          required: true,
          message: t("page.common.price_placeholder"),
          trigger: "blur"
        }
      ],
      props: {
        maxLength: 50,
        placeholder: t("page.common.price_placeholder")
      }
    },
    {
      name: "memo",
      ...
      rules: [
        {
          required: true,
          message: t("page.common.memo_placeholder"),
          trigger: "blur"
        }
      ],
      props: {
